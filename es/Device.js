...
var _a = Dimensions.get("screen"), width = _a.width, height = _a.height;
var staticInfo = {};
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = {};
                        return [4 /*yield*/, DeviceInfo.getBatteryLevel()];
                    case 1:
                        _b.battaryLevel = _c.sent();
                        return [4 /*yield*/, DeviceInfo.isLocationEnabled()];
                    case 2:
                        _b.locationEnabled = _c.sent();
                        return [4 /*yield*/, DeviceInfo.getFreeDiskStorage()];
                    case 3: 
